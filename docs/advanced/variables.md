...
[config-file]: ../getting-started/basic-usage.md#the-configuration-file
[export-variables]: ../getting-started/basic-usage.md#exporting-environment-variable
...
[shell-target]: ../getting-started/basic-usage.md#the-shell-target
