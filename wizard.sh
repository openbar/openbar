...
main() {
	...
	OB_TYPE=$(ask_select "What type of OpenBar project is it?" "simple:initenv:yocto" "simple")
	...
	GIT_TYPE=$(ask_select "How do you want to manage the git repositories?" "submodule:repo" "${GIT_TYPE_DEFAULT}")
